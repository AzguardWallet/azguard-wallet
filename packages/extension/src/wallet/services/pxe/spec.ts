...
export type Methods = {
	getContractInstance(network: Network, address: AztecAddress, opts?: { pxeOnly?: boolean }): ContractInstanceWithAddress | undefined
	getContractArtifact(network: Network, id: Fr, opts?: { pxeOnly?: boolean }): ContractArtifact | undefined
	...
	registerContract(network: Network, contract: { instance: ContractInstanceWithAddress; artifact?: ContractArtifact }): void
	...
	getPrivateEvents<_T>(network: Network, eventSelector: EventSelector, filter: PrivateEventFilter): PackedPrivateEvent[]
}
