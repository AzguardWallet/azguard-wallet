...
const tx = computed(() =>
	appStore.transactions.find((t) => t.hash === cacheStore.activeTxHash)
)

const call = computed(() => tx.value.calls[0])

const transfer = computed(() =>
	call.value.transfers ? call.value.transfers[0] : null
)

const token = computed(() =>
	appStore.tokens.find((t) => call.value.contract === t.contract)
)
