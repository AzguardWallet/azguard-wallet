...
export class Config {
    ...
    // NOTE: renamed from `walletConnectEnabled` so a stored config ignores the old
    // value and every install starts off.
    walletConnect: boolean = false; // Enable WalletConnect dApp connections
