...
// Canonical PrivateFPC v5.0.1 (salt 0, deployer 0, no args), chain-independent. Deployed
// unpublished — the node can't serve the instance, so pin the class id and derive.
