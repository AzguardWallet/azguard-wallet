...
export default defineConfig({
	...
	resolve: {
		alias: {
			...
			"@wonderland-token-artifact": fileURLToPath(new URL("./node_modules/@defi-wonderland/aztec-standards/artifacts/target/token_contract-Token.json", import.meta.url)),
